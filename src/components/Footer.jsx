...
function Footer() {
  return (
    ...
    //       height={300}
    //       priority
    //       className="mx-auto h-30 w-auto object-contain md:h-36"
    //     />
    ...
    //       <h3 className="text-xl font-semibold text-[#CAAA98]">Contact Us</h3>

    //       <p className="text-slate-300">support@velora.com</p>
